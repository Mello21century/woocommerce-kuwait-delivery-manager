            ...
            <div id="kdm-import-area-defaults" style="display:none;">
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <input type="number" id="kdm-base-price" step="0.001" min="0" value="0.000"
                                   class="small-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="number" id="kdm-base-express" step="0.001" min="0" value="0.000"
                                   class="small-text">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="number" id="kdm-base-minimum" step="0.001" min="0" value="0.000"
                                   class="small-text">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
                            <label for="kdm-base-free-minimum"><?php esc_html_e( 'Base Free Delivery Min.', 'kuwait-delivery-manager' ); ?></label>
                        </th>
                        <td>
                            <input type="number" id="kdm-base-free-minimum" step="0.001" min="0" value="0.000"
                                   class="small-text">
                        </td>
                    </tr>
                </table>
            ...
            <div id="kdm-city-resolve-wrap" style="display:none;">
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            <label for="kdm-city-resolve-mode"></label><select id="kdm-city-resolve-mode">
